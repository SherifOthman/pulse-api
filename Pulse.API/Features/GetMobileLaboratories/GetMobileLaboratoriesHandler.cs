...
public class GetMobileLaboratoriesHandler(AppDbContext db)
    : IRequestHandler<GetMobileLaboratoriesQuery, PaginatedResponse<LaboratoryMobileListResponse>>
{
    public async Task<PaginatedResponse<LaboratoryMobileListResponse>> Handle(
        GetMobileLaboratoriesQuery request, CancellationToken ct)
    {
        ...
        var query = db.Businesses
            .AsNoTracking()
            .Where(b => b.Type == BusinessType.Laboratory)
            .ApplyFilters(bq);
        ...
        var items = raw.Items.Select(r =>
        {
            ...
            return new LaboratoryMobileListResponse(
        ...
        return new PaginatedResponse<LaboratoryMobileListResponse>(
