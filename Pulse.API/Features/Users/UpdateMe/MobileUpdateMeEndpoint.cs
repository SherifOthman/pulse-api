using Pulse.API.Features.Users.UpdateMe;
using Pulse.API.Infrastructure;
using MediatR;

namespace Pulse.API.Features.Users.UpdateMe;

public class MobileUpdateMeEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut("/mobile/users/me", async (HttpContext context, IMediator mediator, ICurrentUser currentUser) =>
        {
