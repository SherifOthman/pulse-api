...
public class GetLaboratoryDetailsHandler(AppDbContext db, ICurrentUser currentUser)
    : IRequestHandler<GetLaboratoryDetailsQuery, LaboratoryDetailsResponse?>
{
    public async Task<LaboratoryDetailsResponse?> Handle(GetLaboratoryDetailsQuery request, CancellationToken ct)
    {
        ...
        return new LaboratoryDetailsResponse(
