...
using Pulse.API.Features.Radiology.UpdateRadiology;
using Pulse.API.Persistence;

namespace Pulse.API.Validators;

public class UpdateRadiologyCommandValidator : AbstractValidator<UpdateRadiologyCommand>
{
    public UpdateRadiologyCommandValidator(AppDbContext db)
    {
